...
const SignInFormAdDis = () => {
  ...
  const [role, setRole] = useState("content owner"); // Default role is admin
          ...
          <div className={styles.rightContainer}>
            ...
            <div className={styles.loginForm}>
              <form onSubmit={handleSubmit}>
                  <FormControl sx={{ width: '100%', padding: '10px 20px' }}>
                  <RadioGroup
                    row
...
export default SignInFormAdDis;