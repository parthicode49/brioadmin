...
export const admin_advertisement_create = (formData) => async (dispatch) => {
  try {
    const data = await api.admin_advertisement_create(formData);
    dispatch({ type: MESSAGE, payload: data?.data });
...
export const advertisement_payment_list_admin =
...
export const advertisement_payment_list_advertiser =
  (formData) => async (dispatch) => {
    try {
...
export const advertisement_charge_list = (formData) => async (dispatch) => {
  try {
...
export const advertisement_charge_update = (formData) => async (dispatch) => {
  try {
...
export const advertisement_view_data = (formData) => async (dispatch) => {
  try {
...
export const advertisement_highest_view = (formData) => async (dispatch) => {
  try {
